...
"""This file is to create reusable base API commands GET,POST,PUT,DELETE,PATCH and other"""
env = get_environment()
...
# method to save request details in allure report
...
# method to save response details in allure report
